...
(function () {
  ...
  var SW = {
    ...
    'Refund & cancellation policy': 'Sera ya marejesho na kufuta',
    'Legal': 'Kisheria',
    'Legal documents': 'Nyaraka za kisheria',
    'RailGrid Technologies Limited, a company incorporated in the United Republic of Tanzania · Dar es Salaam, Tanzania': 'RailGrid Technologies Limited, kampuni iliyosajiliwa katika Jamhuri ya Muungano wa Tanzania · Dar es Salaam, Tanzania',
    'We aim to respond within one working day.': 'Tunalenga kujibu ndani ya siku moja ya kazi.',
    'We aim to respond within one working day. Fields marked "required" must be completed.': 'Tunalenga kujibu ndani ya siku moja ya kazi. Sehemu zilizoandikwa "required" ni lazima zijazwe.',
    'We aim to reply within one working day': 'Tunalenga kujibu ndani ya siku moja ya kazi',
    'Client name withheld under NDA · reference available on request, subject to client consent': 'Jina la mteja limehifadhiwa chini ya NDA · rejea inapatikana kwa ombi, kwa ridhaa ya mteja',
    'Please tick the consent box so we may store your details and reply to you.': 'Tafadhali tiki kisanduku cha ridhaa ili tuweze kuhifadhi taarifa zako na kukujibu.',
    'Please choose at least one audience to be reached.': 'Tafadhali chagua angalau hadhira moja.',
    'privacy notice': 'taarifa ya faragha',
    ...
    'Live at a multi‑site mining & civils contractor': 'Inatumika kwa mkandarasi wa madini na ujenzi mwenye maeneo mengi',
    'Hosted, supported and maintained under one annual agreement': 'Inahifadhiwa, inahudumiwa na kudumishwa chini ya mkataba mmoja wa mwaka',
    'Hosted · Supported · Maintained': 'Inahifadhiwa · Inahudumiwa · Inadumishwa',
    'Data stays in your jurisdiction': 'Data inabaki ndani ya mamlaka yako',
    'ERPNext · HCMOS™ · Workforce (illustrative data)': 'ERPNext · HCMOS™ · Wafanyakazi (data ya mfano)',
    ...
    'Multi‑site workforce, camp rosters, gate attendance, grievances, statutory payroll and Exact integration – in production at a multi‑site mining & civils contractor.': 'Wafanyakazi wa maeneo mengi, ratiba za kambi, mahudhurio getini, malalamiko, mishahara ya kisheria na muunganiko na Exact – inatumika kwa mkandarasi wa madini na ujenzi mwenye maeneo mengi.',
    ...
    'A Tanzanian mining & civils contractor replaced spreadsheets and disconnected HR tools with one auditable system.': 'Mkandarasi wa madini na ujenzi wa Tanzania alibadilisha majedwali na zana za rasilimali watu zisizounganishwa kwa mfumo mmoja unaokaguliwa.',
    ...
    'A Tanzanian mining & civils contractor is the first organisation on RailGrid\'s HCMOS™ edition of ERPNext – replacing spreadsheets and disconnected HR tools with one auditable platform across mine sites, camps and head office.': 'Mkandarasi wa madini na ujenzi wa Tanzania ni shirika la kwanza kwenye toleo la HCMOS™ la ERPNext la RailGrid – likibadilisha majedwali na zana za rasilimali watu zisizounganishwa kwa jukwaa moja linalokaguliwa katika maeneo ya mgodi, kambi na makao makuu.',
    'A Tanzanian mining & civils contractor is the first organisation on RailGrid’s HCMOS™ edition of ERPNext – replacing spreadsheets and disconnected HR tools with one auditable platform across mine sites, camps and head office.': 'Mkandarasi wa madini na ujenzi wa Tanzania ni shirika la kwanza kwenye toleo la HCMOS™ la ERPNext la RailGrid – likibadilisha majedwali na zana za rasilimali watu zisizounganishwa kwa jukwaa moja linalokaguliwa katika maeneo ya mgodi, kambi na makao makuu.',
    ...
    'Modules in use at the client.': 'Moduli zinazotumika kwa mteja.',
    'Configured from the HCMOS™ edition, adapted to the client\'s sites, shift patterns and approval structure.': 'Zimesanidiwa kutoka toleo la HCMOS™, zikirekebishwa kulingana na maeneo, mifumo ya zamu na muundo wa idhini wa mteja.',
    'Configured from the HCMOS™ edition, adapted to the client’s sites, shift patterns and approval structure.': 'Zimesanidiwa kutoka toleo la HCMOS™, zikirekebishwa kulingana na maeneo, mifumo ya zamu na muundo wa idhini wa mteja.',
    ...
    'Built in production': 'Imejengwa katika matumizi halisi',
    'Shaped with a live mining & civils client.': 'Imeundwa pamoja na mteja halisi wa madini na ujenzi.',
    ...
    'Clients — a mining & civils contractor on the HCMOS™ edition of ERPNext | RailGrid': 'Wateja — mkandarasi wa madini na ujenzi kwenye toleo la HCMOS™ la ERPNext | RailGrid',
    ...
    'Built to post payroll journals to Exact each cycle, with the audit trail back to every employee record – scheduled as the client\'s next phase.': 'Imejengwa kuchapisha majarida ya mishahara kwenye Exact kila mzunguko, na rekodi ya ukaguzi inayorudi hadi kila rekodi ya mfanyakazi – imepangwa kama awamu inayofuata ya mteja.',
    'Built to post payroll journals to Exact each cycle, with the audit trail back to every employee record – scheduled as the client’s next phase.': 'Imejengwa kuchapisha majarida ya mishahara kwenye Exact kila mzunguko, na rekodi ya ukaguzi inayorudi hadi kila rekodi ya mfanyakazi – imepangwa kama awamu inayofuata ya mteja.',
